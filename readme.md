...
It’s customise with a dropdown button to search for foods by food type. Example: Chinese food, Indian food, Indonesia food, Western food ect, 
A search box is a also provided, with  an alternative search for all food type in Singapore using mobile phone. The search result will be display 
...
Colour Photo
The following colour was choose to assimilate with the map color. I tried to avoid colours that affect people with color blindess deficiency like  Red, Yellow and Green. Ended up to use yellow because I am unable to select a suitable colour. 
